...
<head>
    ...
    <link rel="stylesheet" href="/css/anm_edit.css">
...
<body>
	<form enctype="multipart/form-data">
        ...
        <div class="top">
            <div class="row">
                <div>공고 제목</div>
                <div class="input"><input type="text" id="" class="profile-ip" name="anm_title"></div>
                <div>기업 규모</div>
                <div class="input" ><input type="text" class="profile-ip" name="comptype" value="${principal.company.comptype }"></div>
            </div>
            <div class="row">
                <div>기업이름</div>
                <div class="input" ><input type="text" class="profile-ip" name="compname" value="${principal.company.compname }"></div>
                <div>ceo 이름</div>
                <div class="input" ><input type="text" class="profile-ip" name="ceoname" value="${principal.company.ceoname }"></div>
            </div>
            <div class="row">
                <div>연락처</div>
                <div class="input" ><input type="text" class="profile-ip"name="phone" value="${principal.company.phone }"></div>
                <div>이메일</div>
                <div class="input" ><input type="text" class="profile-ip"name="email" value="${principal.company.email }"></div>
            </div>
        </div>
        ...
        <div class="content">
            <div class="info">
                ...
                <div>
                    ...
                    <div class="edit-ip input inputShort">
                        <input type="text" list="area-ip" class="profile-ip" name="area" value="">
                        <datalist id="area-ip">
                ...
                <div>
                    ...
                    <!-- 고졸이하, 고졸, 전문대졸, 대졸, 대학원이상 -->
                    <div class="edit-ip input inputShort">
                        <input type="text" list="gender-ip" class="profile-ip" name="gender" value="">
                ...
                <div>
                    ...
                    <div class="edit-ip input inputShort">
                        <input type="text" list="goyong-ip" class="profile-ip" name="form_employ" value=" ">
        ...
        <div class="footer">
            <div class="textArea">
                ...
                <div>
                    <div class="firstTxt">
                        <h3>담당업무</h3>
                        <textarea class="profile-ip" name="assign_task" id="" cols="30" rows="10"></textarea>
                        <h3>우대사항</h3>
                        <textarea class="profile-ip" name="loyalty_point" id="" cols="30" rows="10"></textarea>
                    </div>
                    <div class="etcInput">
                        ...
                        <div>
                            ...
                            <div class="edit-ip input inputMiddle">
                                <input type="text" list="day-ip" class="profile-ip" name="working_days" value=" ">
                                <datalist id="day-ip">
                        ...
                        <div>
                            ...
                            <div class="edit-ip input inputMiddle">
                                <input type="text" list="time-ip" class="profile-ip" name="hours_duty" value=" ">
                                <datalist id="time-ip">
                        ...
                        <div>
                            ...
                            <div class="edit-ip input inputMiddle">
                                <input type="text" list="salary-ip" class="profile-ip" name="salary" value=" ">
                        ...
                        <div>
                            ...
                            <div class="edit-ip input inputMiddle">
                                <input type="text" list="recruit-area-ip" class="profile-ip" name="wanted" value=" ">
